...
class DBIDMMySQLInitiator(AMySQLdbInit):
    ...
    def __init__(self, db_config):
        ...
        self.sqlScriptFilePath = "resources/sqlscripts/components/idm_mapping.sql"

    def process(self):
        return super(DBIDMMySQLInitiator, self).process()
