...
class cuMappingRimManagedServiceProcessor(AConfUnit):
    ...
    def __init__(self, targetConfDir):
        ...
        self.confTemplatePath = os.path.abspath("resources/templates/components/net.echinopsii.ariane.community.core.MappingRimManagedService.properties.tpl")
        self.confFinalPath = targetConfDir + "net.echinopsii.ariane.community.core.MappingRimManagedService.properties"
