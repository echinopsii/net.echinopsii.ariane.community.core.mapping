...
org.neo4j.server.database.location=##mappingNeo4JDirectory
...
org.neo4j.server.webadmin.rrdb.location=##mappingNeo4JRRDB
...
org.neo4j.server.db.tuning.properties=##mappingNeo4JTuningPropsFile
...
org.neo4j.server.http.log.config=##mappingNeo4JLogConfigFile

org.neo4j.server.credentials=cc:password
