...
package net.echinopsii.ariane.core.mapping.ds.rim.cfg;
...
public class MappingDSCfgLoader {
    ...
    private static final String MAPPING_DS_CFG_LOADER_BLUEPRINTS_BDL_NAME = "net.echinopsii.ariane.core.mapping.ds.blueprints";
