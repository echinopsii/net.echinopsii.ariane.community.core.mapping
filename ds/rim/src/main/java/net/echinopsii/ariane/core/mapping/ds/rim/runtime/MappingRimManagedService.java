 ...
 */
package net.echinopsii.ariane.core.mapping.ds.rim.runtime;
...
@Component(managedservice="net.echinopsii.ariane.core.MappingRimManagedService")
@Instantiate
public class MappingRimManagedService {
    ...
    private static final String MAPPING_DS_SERVICE_NAME = "Ariane Mapping DS";
