...
package net.echinopsii.ariane.community.core.mapping.ds.rim.factory;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.annotation.JsonValue;

public enum MappingDSRegisteredClassType {
	...
	MAPPING_SCE_FACTORY("mappingSceClass");
	
	@JsonProperty("FACTORY_SCOPE")
	private final String id;
	
	MappingDSRegisteredClassType(String jsonName){
		id = jsonName;
	}
