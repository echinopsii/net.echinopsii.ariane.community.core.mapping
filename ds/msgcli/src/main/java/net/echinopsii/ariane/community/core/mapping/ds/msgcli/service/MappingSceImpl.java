...
public class MappingSceImpl extends SProxMappingSceAbs<SessionImpl, SessionRegistryImpl> {
    ...
    @Override
    public Session openSession(String clientID) throws MappingDSException {
        Map<String, Object> message = new HashMap<>();
        message.put(MomMsgTranslator.OPERATION_FDN, SProxMappingSce.SESSION_MGR_OP_OPEN);
    ...
    @Override
    public Session openSession(String clientID, boolean proxy) throws MappingDSException {
        if (proxy)
    ...
    @Override
    public Session closeSession(Session toClose) throws MappingDSException {
        Map<String, Object> message = new HashMap<>();
        message.put(MomMsgTranslator.OPERATION_FDN, SProxMappingSce.SESSION_MGR_OP_CLOSE);
    ...
    @Override
    public Session closeSession() throws MappingDSException {
        Session ret = null;
    ...
    public Node getNodeByName(Container container, String nodeName) throws MappingDSException {
        ...
        Map<String, Object> message = new HashMap<>();
        message.put(MomMsgTranslator.OPERATION_FDN, OP_GET_NODE_BY_NAME);
    ...
    public Gate getGateByName(Container container, String nodeName) throws MappingDSException {
        ...
        Map<String, Object> message = new HashMap<>();
        message.put(MomMsgTranslator.OPERATION_FDN, OP_GET_GATE_BY_NAME);
        message.put(Container.TOKEN_CT_ID, container.getContainerID());
    ...
    public Set<Link> getLinksBySourceEP(Endpoint endpoint) throws MappingDSException {
        ...
        Map<String, Object> message = new HashMap<>();
        message.put(MomMsgTranslator.OPERATION_FDN, OP_GET_LINKS_BY_SOURCE_EP);
    ...
    public Set<Link> getLinksByDestinationEP(Endpoint endpoint) throws MappingDSException {
        ...
        Map<String, Object> message = new HashMap<>();
        message.put(MomMsgTranslator.OPERATION_FDN, OP_GET_LINKS_BY_DESTINATION_EP);
    ...
    public Link getLinkBySourceEPandDestinationEP(Endpoint esource, Endpoint edest) throws MappingDSException {
        ...
        Map<String, Object> message = new HashMap<>();
        message.put(MomMsgTranslator.OPERATION_FDN, OP_GET_LINK_BY_SOURCE_EP_AND_DESTINATION_EP);
    ...
    public Link getMulticastLinkBySourceEPAndTransport(Endpoint esource, Transport transport) throws MappingDSException {
        ...
        Map<String, Object> message = new HashMap<>();
        message.put(MomMsgTranslator.OPERATION_FDN, OP_GET_LINK_BY_SOURCE_EP_AND_TRANSPORT);
        message.put(LinkSce.PARAM_LINK_SEPID, esource.getEndpointID());
