...
public final class TopoDSGraphPropertyNames {
    ...
    public final static String DD_GRAPH_EDGE_MAXCUR_KEY = "TopoGraphEdgeMaxCursor";
    public final static String DD_GRAPH_VERTEX_TYPE_KEY = "TopoGraphVertexType"; //could be cluster, container, gate, node, endpoint, transport
