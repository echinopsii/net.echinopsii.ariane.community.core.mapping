...
import com.spectral.cc.core.mapping.ds.blueprintsimpl.repository.TopoRepoImpl;
...
public class TopoSceImpl implements TopoSce {

    //private final static Logger log = LoggerFactory.getLogger(TopoSceImpl.class);

    private TopoRepoImpl globalRepo = new TopoRepoImpl();
    ...
    public TopoRepoImpl getGlobalRepo() {
        return globalRepo;
    }
    ...
    public boolean init(Dictionary<Object, Object> properties) {
        try {
            return TopoDSGraphDB.init(properties);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public void unsetAutoCommit() {
        TopoDSGraphDB.setAutocommit(false);
    }

    @Override
    public void setAutoCommit() {
        TopoDSGraphDB.setAutocommit(true);
    }

    @Override
    public void commit() {
        TopoDSGraphDB.commit();
    }

    @Override
    public void rollback() {
        TopoDSGraphDB.rollback();
    }
