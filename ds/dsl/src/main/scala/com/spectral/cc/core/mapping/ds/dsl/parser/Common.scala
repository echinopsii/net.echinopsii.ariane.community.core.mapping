...
import com.spectral.cc.core.mapping.ds.dsl.MapperParserException
...
class Common extends JavaTokenParsers {
  ...
  val ccmonobjtypes = List(MappingDSGraphPropertyNames.DD_TYPE_CONTAINER_VALUE, MappingDSGraphPropertyNames.DD_TYPE_NODE_VALUE, MappingDSGraphPropertyNames.DD_TYPE_ENDPOINT_VALUE)
  val ccmonkeywords = List("from","where","and","or","like","=","!=","<>",">","<",">=","<=","=~",MappingDSGraphPropertyNames.DD_TYPE_CONTAINER_VALUE, MappingDSGraphPropertyNames.DD_TYPE_NODE_VALUE, MappingDSGraphPropertyNames.DD_TYPE_ENDPOINT_VALUE)
