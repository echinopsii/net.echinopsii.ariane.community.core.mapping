...
requirejs (
    ...
    function (Raphael) {
        ...
        var rsr = Raphael('rsr', '28', '28');

        var path_b = rsr.path(" M 62.89 0.00 L 65.34 0.00 C 82.11 0.41 98.62 7.54 110.16 19.75 C 121.30 31.22 127.67 " +
        ...
        path_b.attr({fill: '#333333','stroke-width': '0','stroke-opacity': '1'}).transform("t-50,-50s0.2");

        var path_d = rsr.path(" M 47.96 32.06 C 52.01 25.65 57.35 20.06 63.18 15.24 C 63.59 15.24 64.41 15.24 64.83 " +
        ...
        path_d.attr({fill: '#ffffff','stroke-width': '0','stroke-opacity': '1'}).transform("t-50,-25s0.2");

        var path_e = rsr.path(" M 29.63 57.22 C 30.21 54.28 27.89 48.75 31.93 47.96 C 38.34 51.99 43.91 57.34 48.74 " +
        ...
        path_e.attr({fill: '#ffffff','stroke-width': '0','stroke-opacity': '1'}).transform("t-25,-50s0.2");

        var path_f = rsr.path(" M 95.34 48.36 C 96.38 47.40 98.48 48.47 98.28 49.93 C 98.49 52.36 98.37 54.80 98.38 " +
        ...
        path_f.attr({fill: '#ffffff','stroke-width': '0','stroke-opacity': '1'}).transform("t-75,-50s0.2");

        var path_i = rsr.path(" M 58.67 80.69 C 61.64 78.72 66.32 78.09 68.92 80.94 C 69.96 85.09 70.18 89.40 70.78 " +
            ...
            "80.69 Z");
        path_i.attr({fill: '#ffffff','stroke-width': '0','stroke-opacity': '1'}).transform("t-50,-75s0.2");
    });
