...
define({
    ...
    container_menuFieldsOver  : {'font-size': '10px', 'font-family': 'Arial', 'font-weight': 'bold', 'cursor': 'default', fill: "#fff"},
    ...
    node_strokeWidth : 2,
    node_titleHeight : 34,
    node_txtTitle    : {'font-size': '13px', 'font-family': 'Arial', 'cursor': 'default', fill: '#000'},
    ...
    endpoint_menuFieldsOver  : {'font-size': '10px', 'font-family': 'Arial', 'font-weight': 'bold', 'cursor': 'default', fill: "#fff"},
    ...
    endpoint_txtBxURLTitle  : {'font-size': '12px', 'font-family': 'Arial', 'font-weight': 'bold', 'cursor': 'default', fill: "#fff"},
    endpoint_txtBxURLDef    : {'font-size': '10px', 'font-family': 'Arial', 'cursor': 'default', fill: "#fff"}
});