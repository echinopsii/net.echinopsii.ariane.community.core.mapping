...
require.config({
    ...
    paths: {
        ...
        'taitale-map-splitter': 'js/taitale/layout/netL3+/mapSplitter-min',
        'taitale-layoutntw-registries' : 'js/taitale/layout/netL3+/registries-min',
        'taitale-datacenter': 'js/taitale/layout/netL3+/datacenter/datacenter-min',
        'taitale-datacenter-splitter': 'js/taitale/layout/netL3+/datacenter/dcSplitter-min',
        'taitale-datacenter-hat': 'js/taitale/layout/netL3+/datacenter/hat-min',
        'taitale-datacenter-matrix': 'js/taitale/layout/netL3+/datacenter/matrix-min',
        'taitale-area': 'js/taitale/layout/netL3+/area/area-min',
        'taitale-area-hat': 'js/taitale/layout/netL3+/area/hat-min',
        'taitale-area-matrix': 'js/taitale/layout/netL3+/area/matrix-min',
        'taitale-lan': 'js/taitale/layout/netL3+/lan/lan-min',
        'taitale-lan-matrix': 'js/taitale/layout/netL3+/lan/matrix-min',
        'taitale-lan-hat': 'js/taitale/layout/netL3+/lan/hat-min'
    },
    shim: {
        "jquery-ui": {
            exports: "$",
