...
requirejs (
    ...
    function (Raphael) {
        ...
        function freebsdLogo(x,y) {
            rsr.path("m878.6 605.07c8.07 8.06-14.297 43.508-18.08 47.29-3.78 " +
                ...
                transform("t"+x+","+y+"t-818,-625s0.3");
            rsr.path("m765.47 613.6c-12.314-6.987-29.839-14.761-35.414-9.187-5.648 5.647 2.41 23.566 9.47 35.904 " +
                "6.283-10.924 15.225-20.12 25.944-26.717").
                attr({fill: '#fff',"fill-opacity": '.85','stroke-width': '0','stroke-opacity': '1'}).
                transform("t"+x+","+y+"t-743,-619s0.3");
            rsr.path("m866.29 649.58c1.135 3.848.928 7.02-.908 8.86-4.299 " +
