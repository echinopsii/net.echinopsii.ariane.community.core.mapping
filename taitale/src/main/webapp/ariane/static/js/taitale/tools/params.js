...
define({
    ...
    dc_menuMainTitle   : {'font-size': '14px', 'font-family': 'Arial', 'font-weight': 'bold', 'cursor': 'default', fill: "#fff"},
    ...
    area_menuMainTitle   : {'font-size': '14px', 'font-family': 'Arial', 'font-weight': 'bold', 'cursor': 'default', fill: "#fff"},
    area_menuFields      : {'font-size': '12px', 'font-family': 'Arial', 'font-weight': 'normal', 'cursor': 'default', fill: "#fff"},
    area_menuFieldsOver  : {'font-size': '12px', 'font-family': 'Arial', 'font-weight': 'bold', 'cursor': 'default', fill: "#fff"},
    ...
    node_menuMainTitle   : {'font-size': '14px', 'font-family': 'Arial', 'font-weight': 'bold', 'cursor': 'default', fill: "#fff"},
    ...
    endpoint_menuMainTitle   : {'font-size': '14px', 'font-family': 'Arial', 'font-weight': 'bold', 'cursor': 'default', fill: "#fff"},
