...
network = {
    'subnetip': ['String', '192.168.43.0'],
    'subnetmask': ['String', '255.255.255.0'],
    'type': ['String', 'LAN'],
    'lan': ['String', 'lab02.lan1'],
...
r = s.get(srvurl + 'ariane/rest/mapping/domain/containers/update/properties/delete', params=containerProperty)
...
# r = s.get(srvurl + 'ariane/rest/mapping/domain/containers/get', params=getParams)
# pprint(r.json())
...
# r = s.get(srvurl + 'ariane/rest/mapping/domain/containers')
# pprint(r.json())
...
#                                                          'name': 'MDW BUS'}},
#                  'containerType': 'RV Router Daemon'}]}
# r = s.get(srvurl + 'ariane/rest/mapping/domain/nodes')
# pprint(r.json())
...
#             'nodeTwinNodeID': []}]}
# r = s.get(srvurl + 'ariane/rest/mapping/domain/gates')
# pprint(r.json())
...
#                      'nodeName': 'webadmingate.tibrvrdl06prd01',
#	               'nodeTwinNodeID': []}}]}
# r = s.get(srvurl + 'ariane/rest/mapping/domain/endpoints')
# pprint(r.json())
...
# getParams = {'ID':nodeID}
# r = s.get(srvurl + 'ariane/rest/mapping/domain/nodes/get', params=getParams)
# pprint(r.json())
# {'nodeContainerID': 1,
#  'nodeEndpointID': [7, 8],
#  'nodeID': 6,
...
# r = s.get(srvurl + 'ariane/rest/mapping/domain/endpoints/get', params=getParams)
# pprint(r.json())
# {'endpointID': 7,
#  'endpointParentNodeID': 6,
...
network = {
    'subnetip': ['String', '192.168.44.0'],
    'subnetmask': ['String', '255.255.255.0'],
    'type': ['String', 'LAN'],
    'lan': ['String', 'lab02.lan2'],
    'rarea': ['String', "devilsmindLAN"],
    'multicast': ['boolean', "True"]
}
containerProperty = {'ID': containerID, 'propertyName': 'Network', 'propertyValue': json.dumps(network), 'propertyType': 'map'}
...
r = s.get(srvurl + 'ariane/rest/mapping/domain/nodes/update/twinNodes/add', params=twinNode)
...
r = s.get(srvurl + 'ariane/rest/mapping/domain/endpoints/update/twinEndpoints/add', params=twinEP)
...
transportParams = {"name": "multicast-udp-tibrv://devilsMindLAN;239.69.69.69"}
...
# r = s.get(srvurl + 'ariane/rest/mapping/domain/transports')
# pprint(r.json())
...
# r = s.get(srvurl + 'ariane/rest/mapping/domain/links');
# pprint(r.json())
...
r = s.get(srvurl + 'ariane/rest/mapping/domain/clusters/create', params=clusterParams);
clusterID = r.json().get("clusterID")

clusterParams = {"ID": clusterID, "containerID": clusterContainer1}
r = s.get(srvurl + 'ariane/rest/mapping/domain/clusters/update/containers/add', params=clusterParams);

clusterParams = {"ID": clusterID, "containerID": clusterContainer2}
r = s.get(srvurl + 'ariane/rest/mapping/domain/clusters/update/containers/add', params=clusterParams);

# r = s.get(srvurl + 'ariane/rest/mapping/domain/clusters');
# pprint(r.json())
...
network = {
    ...
    'subnetmask': ['String', '255.255.255.0'],
    'type': ['String', 'MAN'],
    'lan': ['String', 'lab02.man'],
    'rarea': ['String', "devilsmindMAN"],
...
network = {
    ...
    'subnetmask': ['String', '255.255.255.0'],
    'type': ['String', 'WAN'],
    'lan': ['String', 'lab02.wan'],
    'rarea': ['String', "devilsmindWAN"],
    'multicast': ['boolean', "False"]
}
containerProperty = {'ID': containerID, 'propertyName': 'Network', 'propertyValue': json.dumps(network), 'propertyType': 'map'}
r = s.get(srvurl + 'ariane/rest/mapping/domain/containers/update/properties/add', params=containerProperty)
...
r = s.get(srvurl + 'ariane/rest/mapping/domain/endpoints/get', params=paramsRequest)
