...
public class SessionEp {
    ...
    @GET
    @Path("/open")
    public Response openSession(@QueryParam(SProxMappingSce.SESSION_MGR_PARAM_CLIENT_ID) String clientID) {
    ...
    @GET
    @Path("/close")
    public Response closeSession(@QueryParam(SProxMappingSce.SESSION_MGR_PARAM_SESSION_ID) String sessionID) {
        Subject subject = SecurityUtils.getSubject();
    ...
    @GET
    @Path("/commit")
    public Response commit(@QueryParam(SProxMappingSce.SESSION_MGR_PARAM_SESSION_ID)  String sessionID) {
        Subject subject = SecurityUtils.getSubject();
    ...
    @GET
    @Path("/rollback")
    public Response rollback(@QueryParam(SProxMappingSce.SESSION_MGR_PARAM_SESSION_ID)  String sessionID) {
        Subject subject = SecurityUtils.getSubject();
