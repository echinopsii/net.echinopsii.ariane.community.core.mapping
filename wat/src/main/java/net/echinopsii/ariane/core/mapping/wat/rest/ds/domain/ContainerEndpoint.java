 ...
 */
package net.echinopsii.ariane.core.mapping.wat.rest.ds.domain;
...
import net.echinopsii.ariane.core.mapping.ds.domain.Gate;
import net.echinopsii.ariane.core.mapping.ds.domain.Node;
import net.echinopsii.ariane.core.mapping.wat.MappingBootstrap;
import net.echinopsii.ariane.core.mapping.wat.json.ds.domain.ContainerJSON;
import net.echinopsii.ariane.core.mapping.wat.rest.ToolBox;
...
public class ContainerEndpoint {
    ...
    public Response getContainer(@QueryParam("primaryAdminURL") String primaryAdminURL, @QueryParam("ID") long id) {
        if (id!=0) {
            ...
            return Response.status(Status.INTERNAL_SERVER_ERROR).entity("Request error: primaryAdminURL and id are not defined. You must define one of these parameters").build();
        }
    }
